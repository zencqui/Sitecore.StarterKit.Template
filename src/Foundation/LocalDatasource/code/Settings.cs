namespace HelixExample.Foundation.LocalDatasource
{
    public static class Settings
    {
        ...
        public static string LocalDatasourceFolderName =>
            Sitecore.Configuration.Settings.GetSetting(LocalDatasourceFolderNameSetting,
                LocalDatasourceFolderNameDefault);
